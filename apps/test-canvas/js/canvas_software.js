...
var APP = (function(){
    ...
    const BUILD_ITEM = [
        {
            msg : 'canvas(w:1270,h:710),fill color -> ok',
            whAry : [1270,710]
        },
        {
        ...
        {
            msg : 'canvas(w:1190,h:500),fill color -> ok',
            whAry : [1190,500]
        },
        {
        ...
        {
            msg : 'canvas(w:481,h:320),fill color -> ok',
            whAry : [481,320]
        },
        {
        ...
        {
            msg : 'canvas(w:1270,h:710),draw image -> ok',
            whAry : [1270,710],
            imgFlag : true
        },
        {
    ...
    function buildByData(){
        ...
        for(var i =0 ;i < k ; i++){
            ...
            createCanvasDom(obj.msg, obj.whAry,
                            obj.imgFlag || false, obj.gupFlag || false);
        }
    }
